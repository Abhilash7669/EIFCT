...
export default function OurWork() {
    ...
    let cultDescC = "We promote Indian Classical dances like Kathakali, Bharatanatyam, Mohiniyattam, Theyyam, Ottamthullal, Kuchipudi, Thiruvathirakali etc. Also we promote and train Kalaripayattu amongst Children and adults. Kalaripayattu is a martial art designed for the ancient battle field."
    // Animation
